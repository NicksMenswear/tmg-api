...
def get_looks_that_are_linked_to_event() -> list[tuple[UUID, dict]]:
    rows = session.execute(
        text(
            ...
            FROM looks l
            JOIN attendees a ON a.look_id=l.id
...
def main():
    looks = get_looks_that_are_linked_to_event()
    ...
    for look_id, product_spec in looks:
        ...
        add_tags_to_product(look_id, product_id, [TAG_PRODUCT_LINKED_TO_EVENT])
